...
import "../src/UniswapV3LiquidityExamples.sol";

contract UniswapV3LiquidityExamplesTest is Test {
    IWETH  private constant weth = IWETH(WETH);
    IERC20 private constant dai = IERC20(DAI);

    address private constant DAI_WHALE = 0xe81D6f03028107A20DBc83176DA82aE8099E9C42;

    UniswapV3LiquidityExamples private uni = new UniswapV3LiquidityExamples();
